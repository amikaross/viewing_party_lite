  ...
  describe 'instance methods' do 
    describe '#users_parties' do 
      it 'returns a collection of users parties that also includes the status' do 
        user = User.create!(name: "Amanda", email: "amanda@turing.edu", password: "12345")
        party_1 = ViewingParty.create!(movie_id: 1, movie_title: "The Princess Bride", duration: 180, date: '2022-12-12', start_time: '17:00', run_time: 150)
        party_2 = ViewingParty.create!(movie_id: 2, movie_title: "Jurassic Park", duration: 200, date: '2022-12-13', start_time: '19:00', run_time: 150)
        party_3 = ViewingParty.create!(movie_id: 3, movie_title: "Moana", duration: 160, date: '2022-12-14', start_time: '14:00', run_time: 150)
